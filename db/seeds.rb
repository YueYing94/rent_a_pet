...
# ben = User.create(first_name: "Ben", last_name: "Weasley", address: "Foxhole, Wessex, England", email: "ben.weasley@gmail.com", password: 1945478)
# tommi = User.create(first_name: "Tommi", last_name: "Morse", address: "Clover Fields, Street, England", email: "tommi.morse.com", password: 7632132)
# sarah = User.create(first_name: "Sarah", last_name: "Lee", address: "Abbey Road, London, England", email: "sarah.lee@yahoo.com", password: 0231373)
# matt = User.create(first_name: "Matt", last_name: "Johnson", address: "Austen Drive, Bath, England", email: "matt.johnson@gmail.com", password: 3872318)
# maike = User.create(first_name: "Maike", last_name: "Müller", address: "Berliner Strasse, Berlin, Germany", email: "maike.mueller@gmail.com", password: 2891312)
# yue = User.create(first_name: "Yue", last_name: "van de Zand", address: "Grachtenstraat, Amsterdam, Netherlands", email: "yue.vandezand@yahoo.nl", password: 1854389)
# jose = User.create(first_name: "José", last_name: "Alvarez", address: "Las ramblas, Lissabon, Portugal", email: "josé.alvarez@gmail.com", password: 8732763)
# tolu = User.create(first_name: "Tolu", last_name: "Ola", address: "Manchester Square, Manchester, England", email: "tolu.ola@lewagon.uk", password: 9371231)
# max = User.create(first_name: "Max", last_name: "Mercury", address: "Bermondsey Street, London, England ", email: "max.mercury@gmail.com", password: 8461634)
